...
public class ShellTermSession extends GenericTermSession {
    ...
    private void initializeSession() throws IOException {
        ...
        env[1] = "PATH=" + path+":"+getPaths();
        env[2] = "HOME=" + settings.getHomePath();
        String home = "/data/data/peepu.codeeditor/usr/gcc";
        
        
        env[3] = "LIB_DIR="+home+"/aarch64-linux-android/lib";
        env[4] = "INCLUDE_C="+home+"/aarch64-linux-android/include";
        env[5] = "INCLUDE_CPP="+home +"/aarch64-linux-android/include/c++/10.2.0";

        mProcId = createSubprocess(settings.getShell(), env);
    }
    private String getPaths(){
        String home = "/data/data/peepu.codeeditor/usr/gcc";
        String path = home + "/aarch64-linux-android/bin:";
        path += home + "/bin:";
        path += home + "/libexec/gcc/aarch64-linux-android/10.2.0";
        return path;
    }
